		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-base': {submodules: {'aui-base-lang': {skinnable:false}, 'aui-base-core': {skinnable:false, requires:['aui-classnamemanager','aui-node','aui-component','aui-debounce','aui-delayed-task','aui-selector','aui-event-base','oop','yui-throttle']}, 'aui-base-init': {skinnable:false} }, skinnable:false, use:['aui-base-core','aui-base-lang']},
						...
						'aui-simple': {use:['yui','oop','dom','event-custom-base','event-base','pluginhost','node','event-delegate','io-base','json-parse','transition','selector-css3','dom-style-ie','querystring-stringify-simple','aui-base-init','aui-base-core','aui-base-lang','aui-io-request','aui-io-request']},
...
;(function() {
	...
	YUI.AUI = function(o) {
		...
		var alloyInstance = (HAS_WIN && window.Alloy) || ALLOY;
	...
	*/
	if (HAS_WIN) {
		...
		AUI._uaExtensions = function(){};
	}

	AUI._uaExtensions(ALLOY);
})();
AUI.add('aui-base-init', function(A) {
// empty
...
A.mix(
	LString,
	{
		...
		_unescapeNode: DOC && DOC.createElement('a')
	}
);
